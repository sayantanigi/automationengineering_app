...
import { SafeAreaView, ImageBackground, Image, View, Text, Platform } from 'react-native'
...
export default function BusinessContactUs() {
  const platform = Platform.OS
  return (
    <BusinessLayout title="Contact Us" isChildren={true}>
                <View style={styles.bgimgsection}>
                 ...
                 <View style={styles.overlay} />
                    ...
                    <View style={styles.addfulsection}>
                      ...
                      <Image source={require('../../../assets/images/map.png')} style={styles.chatimg} />
                      </View>
                      {/* Map End */}

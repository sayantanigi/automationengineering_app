...
export default function ContactUs() {
  ...
  async function subMitform() {
    (async () => {
      ...
      let response = await fetch(API_URLS.saveContact, {
        method: "POST",
        headers: {
  ...
  return (
    <ExpertLayout MessageTextBarHidden title="Contact Us" isChildren={true} disable={false}>
      ...
      <View style={styles.addfulsection}>
        ...
        <View style={styles.submfga}>
          <TouchableRipple onPress={subMitform}>
